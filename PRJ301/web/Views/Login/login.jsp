                    ...
                    <div class="col-md-6 col-md-offset-3 text-center">
                        <div class="login">
                            <div class="login-form-container">
                                ...
                                <!-- Khi nguoi click login
                                     se gui data ve controller LoginController
                                -->
                                <div class="login-form">
                                    <form action="<%=request.getContextPath()%>/LoginController" method="post">
                                        ...
                                        <div class="button-box">
                                            ...
                                            <p class="mb-5 pb-lg-2" style="color: #393f81;">Don't have an account? <a href="register.jsp" style="color: #e03550;">Register
                                                    here</a></p>
