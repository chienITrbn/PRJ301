                    ...
                    <div class="card-body">
                        ...
                        <form action="<%=request.getContextPath()%>/EditCategory" method="POST">
                            ...
                            <div class="input-group">
                                <input class="input--style-1" type="text" readonly value="${c.id}" name="cid">
                            </div>
                            <div class="input-group">
                                <input class="input--style-1" type="text" placeholder="CategoryName" value="${c.name}" name="nameCat">
                            </div>
                            <div class="p-t-20">
