...
public class LoadBrandController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            List<Product> lProductByBid = dProduct.getAllListProductByBrand(bid);
            request.setAttribute("lCat", lCat);
            request.setAttribute("lProduct", lProductByBid);
